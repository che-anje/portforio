...
<div class="bg-white">
  ...
  <section class="bg-white shadow-sm mb-3 pt-4 pb-3">
    <div class="container col-md-8 col-lg-6">
        ...
        @endif
        <div>
          <a class="open-categories" style="cursor: pointer;color: #2292A4;">もっと見る</a>
          <a class="close-categories" style="display: none;cursor: pointer;color: #2292A4;">閉じる</a>
        </div>
    </div>
  </section>
                ...
                <a class="card card--circle hov--default border-0" href="{{ route('circle.show', [ $circle->id ]) }}">
                    ...
                    <div class="card-body card-body--narrow border rounded-bottom border-top-0 pb-4 ">
                        ...
                        <div class="row no-gutters">
                            <i class="fas fa-map-marker-alt mr-2"><p>{{ $my_prefecture->name }}</p></i>
...
<section class="bg-white shadow-sm mb-3 pt-4 pb-3">
    <div class="container col-md-8 col-lg-6">
      <h2 class="h2 h2--extend -new">新着の「体をうごかす」サークルから探す</h2>
